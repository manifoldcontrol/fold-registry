...
the claim registry for *a singular fold model for capacity-constrained dynamics* (v69), a mathematics preprint whose claim status table is machine-readable and drift-detected.
...
- has the paper changed since a claim was verified: hashes are pinned against `docs/Fold_Bifurcation_v69.pdf`; any byte change flags every affected claim with a CSR004 diagnostic until re-verified and re-pinned

## provenance

- paper: james kovalenko, june 2026. preprint, not peer reviewed; an earlier version is on zenodo (v69 doi to be added on deposit)
